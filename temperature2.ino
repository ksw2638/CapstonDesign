...
String apiKey = "ZLY8FIS5MJLD2CI0"; // to be changed
...
void senddata(int flag) {//implementing double connection in loop function was error
  ...
  if(flag==1){// sending data to my server.
      host = "3.16.76.86";//public ip of your server
      port = 8000; // over 1000
      url = "/log?temp=" + temp; 
  }
  ...
  if(flag==1) {
    host = "http://3.16.76.86";// public ip of your server
  }
